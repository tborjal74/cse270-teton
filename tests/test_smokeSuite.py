...
class TestSmokeSuite():
  ...
  def test_directoryPage(self):
    ...
    self.driver.set_window_size(1295, 979)
    self.driver.find_element(By.ID, "directory-grid").click()
    elements = self.driver.find_elements(By.CSS_SELECTOR, "section:nth-child(1)")
    assert len(elements) > 0
    elements = self.driver.find_elements(By.CSS_SELECTOR, "section:nth-child(2)")
    assert len(elements) > 0
  ...
  def test_homePage(self):
    ...
    self.driver.set_window_size(1296, 978)
  ...
  def test_adminPage(self):
    ...
    self.driver.set_window_size(1234, 978)
    ...
    assert self.driver.find_element(By.CSS_SELECTOR, ".myinput:nth-child(3)").text == "Password:"
  ...
  def test_joinPage(self):
    ...
    self.driver.set_window_size(1259, 979)
    elements = self.driver.find_elements(By.NAME, "fname")
    assert len(elements) > 0
    self.driver.find_element(By.NAME, "fname").click()
    self.driver.find_element(By.NAME, "fname").send_keys("abc")
    self.driver.find_element(By.NAME, "lname").send_keys("abc")
    self.driver.find_element(By.NAME, "bizname").click()
    self.driver.find_element(By.NAME, "bizname").send_keys("abc")
    self.driver.find_element(By.NAME, "biztitle").click()
    self.driver.find_element(By.NAME, "biztitle").send_keys("abc")
